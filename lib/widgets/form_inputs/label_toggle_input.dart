...
class LabelToggleInput extends StatefulWidget {
  const LabelToggleInput({
  ...
  @override
  State<LabelToggleInput> createState() => _LabelToggleInputState();
}

class _LabelToggleInputState extends State<LabelToggleInput> {
